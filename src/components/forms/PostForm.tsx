        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea className="shad-textarea custom-scrollbar" placeholder="whats poppin?" {...field} />
              </FormControl>              
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="text" className="shad-input" placeholder="Food, Memes, News ..."  {...field}/>
              </FormControl>              
              <FormMessage className="shad-form_message"/>
            </FormItem>
          )}
